window.initCgLinkGraph = function({visState, renderAll, data, cgSel}){
  ...
  var maxLayer = d3.max(nodes, d => isFinite(+d.layer) ? +d.layer : 0) || 0
  var yNumTicks = (logitLayer ? parseInt(logitLayer[0].layer) : maxLayer) + 2; // +2 to account for embedding at 0 and layers starting at 1

window.initCgFeatureDetail = async function({visState, renderAll, data, cgSel}){
  ...
  var featureExamples = window.initFeatureExamples ? await window.initFeatureExamples({
  ...
  function renderFeatureDetail() {
    ...
    if (d.is_supergraph_node) {
      headerSel.html('')
      var headerTopRowSel = headerSel.append('div.header-top-row')
